  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-600 selection:text-white flex flex-col justify-between">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="space-y-8 text-sm sm:text-base text-gray-300 leading-relaxed border-t border-white/10 pt-8">
          ...
          <section className="space-y-3">
            ...
            <p>
              When you authorize <strong className="text-white">TikTok AI Coach</strong> to connect to your TikTok account, we access and collect specific information authorized by you via the official TikTok Developer API. The types of data we may collect include:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-400">
              <li><strong className="text-white">Account & Profile Data:</strong> Public profile details, such as your display name, username, profile image, and unique account identifiers.</li>
          ...
          <section className="space-y-3">
            ...
            <p>
              We collect and process your TikTok data strictly to provide and improve the functionality of TikTok AI Coach. Specifically, this data is used to:
            </p>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-400">
              ...
              <li><strong className="text-white">Retention:</strong> We retain your TikTok data only for as long as your TikTok account remains connected to TikTok AI Coach, or as needed to maintain active app features.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-400">
              ...
              <li><strong className="text-white">Data Deletion Request:</strong> To request the permanent deletion of all stored TikTok data, profile info, and tokens from our servers, send an email to <a href="mailto:support@tiktok-ai-coach.com" className="text-blue-400 underline hover:text-blue-300">support@tiktok-ai-coach.com</a> with the subject line <strong className="text-white font-mono text-xs">"TikTok Data Deletion Request"</strong>.</li>
      ...
      <footer className="relative z-10 border-t border-white/10 py-8 text-center text-xs text-gray-500 space-y-2">
        <p>&copy; {new Date().getFullYear()} TikTok AI Coach. All rights reserved.</p>
